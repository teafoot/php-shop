                    ...
                    ?>
                            <li>
                                <a href="product-category.php?id=<?php echo $row['tcat_id']; ?>&type=top-category">
                                    <span data-toggle="collapse" href="#cat-lvl1-id-<?php echo $i; ?>">
                                        <i class="fa fa-plus"></i> <?php echo $row['tcat_name']; ?>
                                    </span>                                    
                                </a>
                                <ul class="collapse" id="cat-lvl1-id-<?php echo $i; ?>">
                                    <?php
                                        $j = 0;
                                    ...
                                    ?>
                                        <li>
                                            <a href="product-category.php?id=<?php echo $row1['mcat_id']; ?>&type=mid-category">
                                                <span data-toggle="collapse" href="#cat-lvl2-id-<?php echo $i.$j; ?>">
                                                    <i class="fa fa-plus"></i> <?php echo $row1['mcat_name']; ?>
                                                </span>
                                            </a>
                                            <ul class="collapse" id="cat-lvl2-id-<?php echo $i.$j; ?>">
                                                <?php
                                                    $k = 0;
