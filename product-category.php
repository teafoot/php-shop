...
<section id="advertisement">
    <div class="container" style="background-image: url(assets/uploads/<?php echo $banner_product_category; ?>)">
        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items">
                    <h3 class="title text-center"><?php echo LANG_VALUE_51; ?> "<?php echo $title; ?>"</h3>
                        <?php
                                            ...
                                            <div class="product-image-wrapper">
                                                <div class="single-products">
                                                    <div class="productinfo text-center">
                                                        <img class="photo" src="<?php echo BASE_URL ?>/assets/uploads/<?php echo $row['p_featured_photo']; ?>"></img>
                                                        ...
                                                        <?php else: ?>
                                                            <a class="btn btn-default add-to-cart" href="product.php?id=<?php echo $row['p_id']; ?>"><i class="fa fa-shopping-cart"></i> <?php echo LANG_VALUE_154; ?></a>
                                                        <?php endif; ?>                                                        
                                                    </div>
                                                </div>
                                            </div>
