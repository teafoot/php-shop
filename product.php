                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <ul class="prod-slider">
                                <li style="background-image: url(<?= BASE_URL ?>/assets/uploads/<?php echo $p_featured_photo; ?>);">
                                ...
                                <?php
                                    ...
                                    foreach ($result as $row) {
                                        ?>
                                        <li style="background-image: url(<?= BASE_URL ?>/assets/uploads/product_photos/<?php echo $row['photo']; ?>);">
                            ...
                            <div id="prod-pager">
                                <a data-slide-index="0">
                                    <div class="prod-pager-thumb" style="background-image: url(<?= BASE_URL ?>/assets/uploads/<?php echo $p_featured_photo; ?>"></div>
                                </a>
                                <?php
                                    $i=1;
                                    $statement = $pdo->prepare("SELECT * FROM tbl_product_photo WHERE p_id=?");
                                    ...
                                    foreach ($result as $row) {
                                        ?>
                                        <a data-slide-index="<?php echo $i; ?>">
                                            <div class="prod-pager-thumb" style="background-image: url(<?= BASE_URL ?>/assets/uploads/product_photos/<?php echo $row['photo']; ?>"></div>
                                        </a>
                                        <?php
                                        $i++;
                                    }
                            ...
                            <div class="category-tab shop-details-tab"><!--category-tab-->
                                <div class="col-sm-12">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#description" data-toggle="tab"><?php echo LANG_VALUE_59; ?></a></li>
                                        <li><a href="#feature" data-toggle="tab"><?php echo LANG_VALUE_60; ?></a></li>
                                        <li><a href="#condition" data-toggle="tab"><?php echo LANG_VALUE_61; ?></a></li>
                                        <li><a href="#return_policy" data-toggle="tab"><?php echo LANG_VALUE_62; ?></a></li>
                                        <li><a href="#review" data-toggle="tab"><?php echo LANG_VALUE_63; ?></a></li>
                                    </ul>
                                </div>
                                          ...
                                          <div class="product-image-wrapper">
                                             <div class="single-products">
                                                <div class="productinfo text-center">
                                                   ...
                                                   <p><a href="product.php?id=<?php echo $row['p_id']; ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i><?php echo LANG_VALUE_154; ?></a></p>
                                                </div>
                                             </div>
                                          </div>
                                    </div>
