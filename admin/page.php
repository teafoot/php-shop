    ...
    if (isset($_POST['form_about'])) {
        ...
        if ($valid == 1) {
            if ($path != '') {
                ...
                // updating the data
                $final_file_name = 'about-banner' . '.' . $ext;
                ...
                $statement->execute(array($_POST['about_title'], $_POST['about_content'], $final_file_name, $_POST['about_meta_title'], $_POST['about_meta_keyword'], $_POST['about_meta_description']));
            } else {
    ...
    if (isset($_POST['form_faq'])) {
        ...
        if ($valid == 1) {
            if ($path != '') {
                ...
                // updating the data
                $final_file_name = 'faq-banner' . '.' . $ext;
                move_uploaded_file($path_tmp, '../assets/uploads/' . $final_file_name);
                ...
                $statement->execute(array($_POST['faq_title'], $final_file_name, $_POST['faq_meta_title'], $_POST['faq_meta_keyword'], $_POST['faq_meta_description']));
            } else {
                // updating the database w/o photo
    ...
    if (isset($_POST['form_blog'])) {
        ...
        if ($valid == 1) {
            if ($path != '') {
                ...
                // updating the data
                $final_file_name = 'blog-banner' . '.' . $ext;
                move_uploaded_file($path_tmp, '../assets/uploads/' . $final_file_name);
                ...
                $statement->execute(array($_POST['blog_title'], $final_file_name, $_POST['blog_meta_title'], $_POST['blog_meta_keyword'], $_POST['blog_meta_description']));
            } else {
                // updating the database w/o photo
    ...
    if (isset($_POST['form_contact'])) {
        ...
        if ($valid == 1) {
            if ($path != '') {
                ...
                // updating the data
                $final_file_name = 'contact-banner' . '.' . $ext;
                move_uploaded_file($path_tmp, '../assets/uploads/' . $final_file_name);
                ...
                $statement->execute(array($_POST['contact_title'], $final_file_name, $_POST['contact_meta_title'], $_POST['contact_meta_keyword'], $_POST['contact_meta_description']));
            } else {
                // updating the database w/o photo
    ...
    if (isset($_POST['form_pgallery'])) {
        ...
        if ($valid == 1) {
            if ($path != '') {
                ...
                // updating the data
                $final_file_name = 'pgallery-banner' . '.' . $ext;
                move_uploaded_file($path_tmp, '../assets/uploads/' . $final_file_name);
                ...
                $statement->execute(array($_POST['pgallery_title'], $final_file_name, $_POST['pgallery_meta_title'], $_POST['pgallery_meta_keyword'], $_POST['pgallery_meta_description']));
            } else {
                // updating the database w/o photo
    ...
    if (isset($_POST['form_vgallery'])) {
        ...
        if ($valid == 1) {
            if ($path != '') {
                ...
                // updating the data
                $final_file_name = 'vgallery-banner' . '.' . $ext;
                move_uploaded_file($path_tmp, '../assets/uploads/' . $final_file_name);
                ...
                $statement->execute(array($_POST['vgallery_title'], $final_file_name, $_POST['vgallery_meta_title'], $_POST['vgallery_meta_keyword'], $_POST['vgallery_meta_description']));
            } else {
                // updating the database w/o photo
        ...
        <div class="panel with-nav-tabs panel-default">
            <div class="panel-heading">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab2primary" data-toggle="tab">FAQ</a></li>
                    <li><a href="#tab3primary" data-toggle="tab">Blog</a></li>
                    <li><a href="#tab4primary" data-toggle="tab">Contact</a></li>
                    <li><a href="#tab5primary" data-toggle="tab">Photo Gallery</a></li>
                    <li><a href="#tab6primary" data-toggle="tab">Video Gallery</a></li>
                </ul>
            </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="tab1primary">
                        <form class="" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-md-2">  
                                    <label for="" class="control-label">Existing Banner Photo</label>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <div class="col-md-2">  
                                    <label for="" class="control-label">New Banner Photo</label>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="tab-pane fade" id="tab2primary">
                        <form class="" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">                                            
                                <div class="col-md-offset-2 col-md-6">                            
                                    <button type="submit" class="btn btn-success" name="form_faq">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="tab-pane fade" id="tab3primary">
                        <form class="" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">                                            
                                <div class="col-md-offset-2 col-md-6">
                                    <button type="submit" class="btn btn-success" name="form_blog">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
