<?php
/**
 * A simple CSRF class to protect forms against CSRF attacks. The class uses PHP sessions for storage.
...
class CSRF_Protect
{
	...
	// Generates a new token value and stores it in persisent storage, or else does nothing if one already exists in persisent storage
