...
<div class="page-banner" style="background-image: url(<?= BASE_URL ?>assets/uploads/<?php echo $banner_cart; ?>)">
                            ...
                            <table class="table table-responsive">
                                ...
                                <?php for($i=1;$i<=count($arr_cart_p_id);$i++): ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td>
                                            <img src="<?= BASE_URL ?>assets/uploads/<?php echo $arr_cart_p_featured_photo[$i]; ?>" alt="">
                                        </td>
